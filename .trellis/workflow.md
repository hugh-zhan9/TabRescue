...
# Read engineering guidelines index (if applicable)
cat .trellis/spec/engineering/index.md
```

**Why read both?**
- Understand the full project architecture
- Know coding standards for the entire codebase
- See how UI code and non-UI runtime code interact
...
**Engineering / Runtime Task**:
```bash
cat .trellis/spec/engineering/storage-guidelines.md        # For persistence
cat .trellis/spec/engineering/compatibility-guidelines.md  # For browser support
cat .trellis/spec/engineering/logging-guidelines.md        # For logging
```
...
|   |-- engineering/     # Non-UI engineering guidelines (if applicable)
|   |   |-- index.md               # Start here - guidelines index
|   |   +-- *.md                   # Topic-specific docs
...
**Engineering / Runtime Development** (if applicable):
```bash
# Read index first, then specific docs based on task
cat .trellis/spec/engineering/index.md
```
...
- See `.trellis/spec/engineering/quality-guidelines.md` for engineering/runtime code
...
|   |-- index.md        # Start here
|   +-- *.md            # Topic-specific docs
|-- engineering/       # Non-UI engineering docs (if applicable)
|   |-- index.md        # Start here
|   +-- *.md            # Topic-specific docs
+-- guides/             # Thinking guides
    |-- index.md        # Start here
...
| Engineering/runtime work | `engineering/index.md` → relevant docs |
