...
def write_prd_engineering_section() -> str:
    """Write PRD engineering section."""
    return """
...
|------|------------------|
| `.trellis/spec/engineering/error-handling.md` | Failure handling, recovery behavior, and stable error codes |
| `.trellis/spec/engineering/logging-guidelines.md` | Log levels, context fields, privacy-safe logging |
...
| `.trellis/spec/engineering/quality-guidelines.md` | Testing, review checks, and engineering quality bar |
"""
...
def write_prd(task_dir: Path, project_type: str) -> None:
    ...
    if project_type == "frontend":
        ...
        content += write_prd_engineering_section()
    else:  # fullstack
        content += write_prd_engineering_section()
        content += write_prd_frontend_section()
...
def write_task_json(task_dir: Path, developer: str, project_type: str) -> None:
    ...
    if project_type == "frontend":
        ...
        subtasks = [
            {"name": "Fill engineering guidelines", "status": "pending"},
            {"name": "Add code examples", "status": "pending"},
        ]
        related_files = [".trellis/spec/engineering/"]
    else:  # fullstack
        subtasks = [
            {"name": "Fill engineering guidelines", "status": "pending"},
            {"name": "Fill frontend guidelines", "status": "pending"},
        ...
        related_files = [".trellis/spec/engineering/", ".trellis/spec/frontend/"]
